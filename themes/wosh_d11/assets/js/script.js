...
/*--------------------------------------------------*/
    //MODIFIED PAGES
	$('.path-frontpage .wrapper').addClass('framed-layout');
	$('.page-home-03 .wrapper').addClass('boxed-layout');
	$('.page-home-03 .primary-navbar').removeClass('text-md-center');
	$('.page-home-03 .primary-navbar').addClass('text-md-right');
	$('.page-home-06 .wrapper').addClass('header-transparent');
	$('.page-home-06 .layout-wrap').addClass('sticky-header');
	$('.page-home-06 footer').addClass('light-footer');
	$('.page-home-06 footer').removeClass('text-light');
